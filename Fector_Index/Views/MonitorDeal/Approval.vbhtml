...
@Code
    ViewData("Title") = "Approval Close Deal"
...
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="pull-left">
                <h4>Monitor Deal Approval List</h4>
            </div>
...
@Using Html.BeginForm(Action, "MonitorDeal", FormMethod.Post, New With {.class = "panel panel-default", .id = "frmData"})
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="height: 200px;">
                    <div class="col-md-12 ">
                        ...
                        @Html.CustomTextBoxFor(Function(f) f.ProcessName, New With {.class = "form-control hidden", .placeholder = "Deal Number", .style = "text-transform:uppercase"})
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" id="btnApprove" value="Approve"><i class="fa fa-check"></i> Approve</button>
                    <button class="btn btn-danger" id="btnReject" value="Reject"><i class="fa fa-close"></i> Reject</button>
                </div>
            </div>
        </div>
    </div>
...
@Section scripts
    <script>
        ...
        var ajaxHandler = '@Url.Action("DTMonitorDealApprovalAjaxHandler")';

        $(document).ready(function () {
            $('#DealNumber').attr('readonly', 'readonly');
            $('#CloseDealReason').attr('readonly', 'readonly');
        });
    ...
    @Scripts.Render("~/Scripts/datatables/monitordeal-approval.js")
