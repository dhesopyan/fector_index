@ModelType Fector_Index.RptDataKursView 
@Code
    ViewData("Title") = "Report Data Kurs"
    Layout = "~/Views/Shared/_Layout.vbhtml"
    Dim Action As String = ViewContext.Controller.ValueProvider.GetValue("Action").RawValue
    Dim CurrencyList As IEnumerable(Of SelectListItem) = ViewBag.Currency
    
End Code

<div class="col-md-12">
    @Using Html.BeginForm("RptDataKurs", "Report", FormMethod.Post, New With {.class = "panel panel-default", .defaultbutton = "frmData"})
        @Html.AntiForgeryToken()
        @<div class="panel-heading">
            <div class="pull-left">
                <h4>Report Audit Trail User</h4>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <div class="form-inline ">
                        ...
                        <label>-</label>
                        <div class="form-group">
                            @Html.CustomTextBoxFor(Function(f) f.EndPeriod, New With {.class = "form-control", .placeholder = "End Period", .style = "text-transform:uppercase; width:195px;"})
             ...
             <div class="row">
                 <div class="form-group col-md-4">
                     ...
                     <div class="form-group">
                         @Html.DropDownListFor(Function(f) f.Currency, CurrencyList, New With {.class = "form-control", .placeholder = "Currency"})
        ...
        @<div class="panel-footer">
            <div class="pull-right">
                ...
                <a id="BtnBack" class="btn btn-danger" href="@Url.Action("IndexDataKurs", "Report")"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
            <div class="clearfix"></div>
        </div>
    End Using
