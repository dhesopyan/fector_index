@ModelType Fector_Index.RptDealView 
@Code
    ViewData("Title") = "Report Deal"
    Layout = "~/Views/Shared/_Layout.vbhtml"
    Dim Action As String = ViewContext.Controller.ValueProvider.GetValue("Action").RawValue
End Code

<div class="col-md-12">
    @Using Html.BeginForm("RptDeal", "Report", FormMethod.Post, New With {.class = "panel panel-default", .defaultbutton = "frmData"})
