@ModelType Fector_Index.RptAuditTrailUserView 
@Code
    ViewData("Title") = "Report Audit Trail User"
    Layout = "~/Views/Shared/_Layout.vbhtml"
    Dim Action As String = ViewContext.Controller.ValueProvider.GetValue("Action").RawValue
End Code

<div class="col-md-12">
    @Using Html.BeginForm("RptAuditTrailUser", "Report", FormMethod.Post, New With {.class = "panel panel-default", .defaultbutton = "frmData"})
        ...
        @<div class="panel-footer">
            <div class="pull-right">
                ...
                <a id="BtnBack" class="btn btn-danger" href="@Url.Action("IndexAuditTrailUser", "Report")"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
            <div class="clearfix"></div>
        </div>
    End Using
