@ModelType Fector_Index.MsExtractSettingTransaction 
@Code
...
<div class="col-md-12">
    @Using Html.BeginForm(Action, "ExtractSettingTransaction", FormMethod.Post, New With {.class = "panel panel-default", .defaultbutton = "BtnSubmit"})
        ...
        @<div class="panel-footer">
            <div class="pull-right">
                ...
                <a id="BtnBack" class="btn btn-danger" href="@Url.Action("Index", "ExtractSettingTransaction")"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
            <div class="clearfix"></div>
        </div>
    End Using
