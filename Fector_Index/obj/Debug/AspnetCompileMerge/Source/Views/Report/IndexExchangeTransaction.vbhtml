@ModelType Fector_Index.RptExchangeTransactionView
@Code
    ViewData("Title") = "Report Exchange Transaction Detail"
    Layout = "~/Views/Shared/_Layout.vbhtml"
    Dim Action As String = ViewContext.Controller.ValueProvider.GetValue("Action").RawValue
End Code

<div class="col-md-12">
    @Using Html.BeginForm("RptExchangeTransactionWithDetail", "Report", FormMethod.Post, New With {.class = "panel panel-default", .defaultbutton = "frmData"})
        @Html.AntiForgeryToken()
        @<div class="panel-heading">
            <div class="pull-left">
                <h4>Report Exchange Transaction Detail</h4>
            </div>
        ...
        @<div class="panel-footer">
            <div class="pull-right">
                ...
                <a id="BtnBack" class="btn btn-danger" href="@Url.Action("IndexExchangeTransaction", "Report")"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
            <div class="clearfix"></div>
        </div>
    End Using
