@ModelType Fector_Index.RptExportTransaction 
@Code
    ViewData("Title") = "Report Export Transaction"
    Layout = "~/Views/Shared/_Layout.vbhtml"
End Code

<div class="col-md-12">
    @Using Html.BeginForm("RptExportTransaction", "Report", FormMethod.Post, New With {.class = "panel panel-default"})
        @Html.AntiForgeryToken()
        @<div class="panel-heading">
            <div class="pull-left">
                <h4>Report Export Transaction</h4>
            </div>
        ...
        @<div class="panel-footer">
            <div class="pull-right">
                ...
                <a id="BtnBack" class="btn btn-danger" href="@Url.Action("IndexExportTransaction", "Report")"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
            <div class="clearfix"></div>
        </div>
    End Using
