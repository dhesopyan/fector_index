$(document).ready(function () {
    ...
    var table = $('#myTable').DataTable({
        ...
        "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
            ...
            if (status.indexOf("ACTIVE") > -1) {
                controller = '<div><a href="' + baseUrl + 'MappingDocument/Edit/' + id + '/" title="Edit"><span class="btn btn-info btn-sm fa fa-edit"></span><a>' +
    ...
    //    });
    //});
    //$('#myTable tbody').on("click", "#formINACTIVEMappingDocument", function () {
    //    var obj = $(this);
    //    bootbox.confirm("Are you sure want to INACTIVE this mapping document?", function (result) {
    //        if (result) {
    //            obj.submit();
    //        }
    //    });
    //});
    //$('#myTable tbody').on("click", "#formACTIVEMappingDocument", function () {
    //    var obj = $(this);
    //    bootbox.confirm("Are you sure want to ACTIVE this mapping document?", function (result) {
    //        if (result) {
    //            obj.submit();
    //        }
    //    });
