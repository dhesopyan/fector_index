@ModelType Fector_Index.MsOtherAccount
@Code
...
<div class="col-md-12">
    @Using Html.BeginForm(Action, "OtherAccount", FormMethod.Post, New With {.class = "panel panel-default", .id = "frmData"})
                 ...
                 <div class="form-group col-md-6">
                     ...
                     <div class="input-group">
                         ...
                         <span class="input-group-btn">
                             ...
                             <a href="@Url.Action("BrowseBICode", "OtherAccount")" class="modal-link btn btn-default" id="btnsearchbicode" title="Browse"><i class='fa fa-search'></i></a>
                         </span>
                     </div>
        ...
        @<div class="panel-footer">
            <div class="pull-right">
                ...
                @If (Action = "Process") Then
                    @<a id="BtnBack" class="btn btn-danger" href="@Url.Action("Approval", "OtherAccount")"><i class="fa fa-arrow-left"></i> Back</a>
                Else
                    @<a id="BtnBack" class="btn btn-danger" href="@Url.Action("Index", "OtherAccount")"><i class="fa fa-arrow-left"></i> Back</a>
                End If
            </div>
            <div class="clearfix"></div>
        </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#modal-container').on('hidden.bs.modal', function () {
                ...
                $('#btnsearchbicode').attr('href', '@Url.Action("BrowseBICode", "OtherAccount")');
            });
