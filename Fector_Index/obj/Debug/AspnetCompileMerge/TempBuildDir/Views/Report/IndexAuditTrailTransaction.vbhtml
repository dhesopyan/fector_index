@ModelType Fector_Index.RptAuditTrailTransactionView 
@Code
    ViewData("Title") = "Report Audit Trail Transaction"
    Layout = "~/Views/Shared/_Layout.vbhtml"
    Dim Action As String = ViewContext.Controller.ValueProvider.GetValue("Action").RawValue
End Code

<div class="col-md-12">
    @Using Html.BeginForm("RptAuditTrailTransaction", "Report", FormMethod.Post, New With {.class = "panel panel-default", .defaultbutton = "frmData"})
        @Html.AntiForgeryToken()
        @<div class="panel-heading">
            <div class="pull-left">
                <h4>Report Audit Trail Transaction</h4>
            </div>
        ...
        @<div class="panel-footer">
            <div class="pull-right">
                ...
                <a id="BtnBack" class="btn btn-danger" href="@Url.Action("IndexAuditTrailTransaction", "Report")"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
            <div class="clearfix"></div>
        </div>
    End Using
