$(document).ready(function () {
    ...
    var table = $('#myTable').DataTable({
        ...
        "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
            ...
            var controller = '<div>' +
                             '<form id="formUnblock" action="' + baseUrl + 'User/UnblockUser" method="post"  class="btn btn-info btn-sm fa fa-check-square" title="Unblock">' +
    ...
    $('#myTable tbody').on("click", "#formUnblock", function () {
        var obj = $(this);
        bootbox.confirm("Are you sure want to unblock this user?", function (result) {
            if (result) {
                obj.submit();
            }
        });
